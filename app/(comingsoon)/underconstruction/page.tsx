export const metadata = {
    title: "Coming Soon | Horizon Developers",
    description: "Exciting new features are on the way at Horizon Developers! Stay tuned for updates on our upcoming projects and enhancements.",
    keywords: "Coming Soon, Horizon Developers, new features, updates, software development, web applications",
...
export default function UnderConstruction() {
    return (
        <section>
            <div 
                className="mx-auto max-w-6xl sm:px-6 text-center px-5 relative max-h-[70vh]"
            >
                ...
                <div className="z-50 flex flex-col justify-center text-white w-full h-screen">
                    ...
                    <div className="mt-6 flex text-white mx-auto">
                        <a href="#" aria-label="Twitter">
                            <svg fill="currentColor" className="cursor-pointer h-6 mr-2" viewBox="0 0 24 24">
