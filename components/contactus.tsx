                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-transparent dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
            ...
            <div className="divide-y divide-gray-200 dark:divide-neutral-800">
              ...
              <div className="flex gap-x-7 py-6">
                ...
                <div className="grow">
                  ...
                  <a className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="mailto:example@site.com">
                    info@horizondevelopers.co.za</a>
                </div>
              </div>
              {/* <!-- End Icon Block --> */}
            </div>
