...
const testimonials = [
  {
    ...
    company: "NexGen Tech",
    content:
      "Horizon Developers transformed our web application. Their expertise made the development process smooth and efficient, and the end product exceeded our expectations!",
    categories: [1, 2],
  },
  {
    ...
    content:
      "Working with Horizon Developers was a game-changer. Their team delivered a stunning web app that perfectly aligns with our brand's vision and engages our customers!",
    categories: [1, 2],
  },
  {
    ...
    company: "EcomSphere",
    content:
      "Our eCommerce site has never performed better! Horizon Developers provided a seamless experience from start to finish, allowing us to launch ahead of schedule.",
    categories: [1, 3],
  },
  {
    ...
    name: "Pavel M.",
    company: "TechWave Corp",
    content:
      "The web solutions provided by Horizon Developers have elevated our online presence. Their attention to detail and commitment to quality are unmatched!",
    categories: [1, 4],
  },
  {
    ...
    company: "Innovatech",
    content:
      "Thanks to Horizon Developers, our enterprise-level app is not only user-friendly but also incredibly powerful. Their team truly understands what it takes to succeed!",
    categories: [1, 4, 5],
  },
  {
    ...
    content:
      "Horizon Developers delivered a versatile web application that perfectly meets our needs. Their innovative approach has made a significant impact on our business!",
    categories: [1, 2],
  },
  {
    ...
    content:
      "Creating our web platform with Horizon Developers was effortless! Their expertise helped us launch a professional site that truly reflects our brand.",
    categories: [1, 2],
  },
  {
    ...
    content:
      "Horizon Developers made the complex world of web development easy for us. Their streamlined process and clear communication set them apart.",
    categories: [1, 4],
  },
  {
    ...
    content:
      "I never thought creating an enterprise-level app could be so straightforward. Horizon Developers took the stress out of the process, and the results speak for themselves!",
    categories: [1, 4, 5],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          We provide tech-driven software solutions that empower businesses to create efficient and engaging workspaces, enabling them to thrive from anywhere in the world.
          </p>
        </div>
