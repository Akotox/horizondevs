// To parse this data:
//
//   import { Convert, Blog } from "./file";
//
//   const blog = Convert.toBlog(json);
//
...
export class Convert {
    public static toBlog(json: string): Blog {
        return cast(JSON.parse(json), r("Blog"));
    }

    public static blogToJson(value: Blog): string {
        return JSON.stringify(uncast(value, r("Blog")), null, 2);
    }
}
...
const typeMap: any = {
    "Blog": o([
        ...
        { json: "related", js: "related", typ: a(r("Related")) },
        { json: "headlines", js: "headlines", typ: "" },
        { json: "repo", js: "repo", typ: "" },
        { json: "suggestedCourses", js: "suggestedCourses", typ: a(r("Related")) },
